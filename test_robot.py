...
def test_illegal_move_north(robot):
    ...
    robot.move()
    robot.move()
    robot.move()  #move robot to col:1, row:1
...
def test_illegal_move_east(robot):
    ...
    robot.move()
    robot.move()
    robot.move()  #move robot to col:10, row:10
...
def test_move_south(robot):
    robot.move() #move to north one step first
    robot.turn()
    robot.turn()
    robot.move() #move to south validly
    state = robot.state()
    assert state['row'] == 10
    assert state['col'] == 1
...
def test_move_west(robot):
    robot.turn()
    robot.move() #move to east one step first
    robot.turn()
    robot.turn()
    robot.move() #move to west validly
    state = robot.state()
    assert state['row'] == 10
    assert state['col'] == 1
